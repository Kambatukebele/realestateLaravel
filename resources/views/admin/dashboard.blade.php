...
@section('page-title', 'Kamba Realty')
              ...
              <div class="layer w-100">
                <div class="layers">
                  <div class="layer w-100">
                    ...
                    <small class="fw-600 c-grey-700">Visitors From
                      USA</small>
            ...
            <ul class="list-task list-group" data-role="tasklist">
              <li class="list-group-item bdw-0" data-role="task">
                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                  ...
                  <label for="inputCall1" class="form-label peers peer-greed js-sb ai-c"><span
                      class="peer peer-greed">Call John for
                      Dinner</span></label>
                </div>
              </li>
              <li class="list-group-item bdw-0" data-role="task">
                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                  ...
                  <label for="inputCall2" class="form-label peers peer-greed js-sb ai-c"><span
                      class="peer peer-greed">Book Boss
                      Flight</span>
                    <span class="peer"><span class="badge rounded-pill fl-r bg-success lh-0 p-10">2
              ...
              <li class="list-group-item bdw-0" data-role="task">
                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                  ...
                  <label for="inputCall3" class="form-label peers peer-greed js-sb ai-c"><span
                      class="peer peer-greed">Hit the
                      Gym</span>
                    <span class="peer"><span class="badge rounded-pill fl-r bg-danger lh-0 p-10">3
              ...
              <li class="list-group-item bdw-0" data-role="task">
                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                  ...
                  <label for="inputCall4" class="form-label peers peer-greed js-sb ai-c"><span
                      class="peer peer-greed">Give Purchase
                      Report</span>
                    <span class="peer"><span class="badge rounded-pill fl-r bg-warning lh-0 p-10">not
              ...
              <li class="list-group-item bdw-0" data-role="task">
                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                  ...
                  <label for="inputCall5" class="form-label peers peer-greed js-sb ai-c"><span
                      class="peer peer-greed">Watch Game of
                      Thrones
                      Episode</span>
              ...
              <li class="list-group-item bdw-0" data-role="task">
                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                  ...
                  <label for="inputCall6" class="form-label peers peer-greed js-sb ai-c"><span
                      class="peer peer-greed">Give Purchase
                      report</span>
                    <span class="peer"><span
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-red-50 c-red-700 p-10 lh-0 tt-c rounded-pill">Unavailable</span>
                    </td>
                    <td>Nov 18</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-deep-purple-50 c-deep-purple-700 p-10 lh-0 tt-c rounded-pill">New</span>
                    </td>
                    <td>Nov 19</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-pink-50 c-pink-700 p-10 lh-0 tt-c rounded-pill">New</span>
                    </td>
                    <td>Nov 20</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-green-50 c-green-700 p-10 lh-0 tt-c rounded-pill">Unavailable</span>
                    </td>
                    <td>Nov 21</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-red-50 c-red-700 p-10 lh-0 tt-c rounded-pill">Used</span>
                    </td>
                    <td>Nov 22</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-orange-50 c-orange-700 p-10 lh-0 tt-c rounded-pill">Used</span>
                    </td>
                    <td>Nov 23</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bgc-yellow-50 c-yellow-700 p-10 lh-0 tt-c rounded-pill">Old</span>
                    </td>
                    <td>Nov 22</td>
                    <td>
            ...
            <div class="peers ai-c jc-sb fxw-nw">
              <div class="peer peer-greed">
                <div class="layers">
                  ...
                  <div class="layer w-100">
                    <span class="fw-600 c-grey-600">Partly
                      Clouds</span>
                  </div>
                </div>
              </div>
              <div class="peer">
                <div class="layers ai-fe">
                  ...
                  <div class="layer">
                    <span class="fw-600 c-grey-600">Nov, 01
                      2017</span>
                  </div>
                </div>
              </div>
          ...
          <div class="layer w-100">
            <div class="peers peers-greed ai-fs ta-c">
              ...
              <div class="peer">
                ...
                <canvas class="clear-day" width="30" height="30"></canvas><span
                  class="d-b fw-600">30<sup>°F</sup></span>
              </div>
              <div class="peer">
                <h6 class="mB-10">WED</h6>
                <canvas class="partly-cloudy-day" width="30" height="30"></canvas><span
